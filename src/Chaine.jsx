    ...
    return (
        <>
            <div className="flex border border-gray-500 py-3 px-3">
                <img src={user.thumbnailProfil} className="w-20 mb-70 self-start rounded-full" />
                <div className="flex flex-col  ms-3  justify-center">
                    ...
                    {props.url && <img src={props.url} className=" h-60 max-w-full lg:max-w-full  rounded-md mt-8 object-content" />}
